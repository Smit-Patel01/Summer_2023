...
data = np.loadtxt('structure_3.dat')
print(data.shape)
...
file_path_for_save = 'just_12/'+model_coded_name+'.h5py'

file_path_for_checkpoints = 'just_12/'+model_coded_name

log_dir = "just_12/" + model_coded_name
